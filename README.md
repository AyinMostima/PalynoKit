...
First, install PyTorch according to your system's CUDA version for GPU support. Visit the  for the correct command.
...
Of course. Here is the updated `README.md` file with the optional installation steps included.
